...
def handle(text: str, context: dict) -> str:
    ...
    return (
        "Robotics3D � un'azienda che si occupa di progettazione e sviluppo di robot educativi "
        ...
        "Il nostro staff � composto da: Paolo, Fabio, Leo, Sara, Francesco ed Ennio. "
